...
namespace IOStreams.Tests
{
    ...
    public class IOStreamTaskTests
    {
        ...
        public void ReadPlanetInfoFromXlsx_Should_Parse_Excel_File()
        {
            ...
            var actual = IOStreamTask.ReadPlanetInfoFromXlsx(ResourseFileName).ToArray();
        ...
        public void DecompressStream_Should_Extract_Data_Correctly()
        {
            ...
            foreach (var data in testData)
            {
                ...
                {
                    using (var stream = IOStreamTask.DecompressStream(data.Key, data.Value))
                    {
        ...
        public void ReadEncodedText_Should_Convert_Text_Using_Specified_Encoding()
        {
            ...
            var actual = IOStreamTask.ReadEncodedText(EncodedFileName, "ISO-8859-1");
